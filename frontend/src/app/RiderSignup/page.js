...
export default function RiderSignup() {
  ...
  return (
    <div className="bg-neutral min-h-screen">
      <Head>
        <title>Rider Sign Up - Food Delivery App</title>
        <meta name="description" content="Sign up as a rider for Food Delivery" />
      ...
      <div className="flex items-center text-black justify-center py-12">
        <div className="bg-white border border-accent rounded-lg shadow p-6 w-full max-w-md">
          <h2 className="text-text text-2xl font-semibold mb-6">Rider Sign Up</h2>
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label htmlFor="vehicleType" className="block text-text font-medium mb-2">
                Vehicle Type
              </label>
              <select
                id="vehicleType"
            ...
            <div className="mb-4">
              <label htmlFor="licenseNumber" className="block text-text font-medium mb-2">
                License Number
              </label>
              <input
                type="text"
